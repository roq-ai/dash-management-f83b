  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.punch_in ? format(parseISO(record?.punch_in as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'punch_out',
      header: 'Punch Out',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.punch_out ? format(parseISO(record?.punch_out as unknown as string), 'dd-MM-yyyy') : '',
    },
