...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'seo-manager', 'content-creator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Backlinks', path: '/backlinks', entity: 'backlink', service: AccessServiceEnum.PROJECT, icon: FiLink },
    {
      name: 'Time Trackings',
      path: '/time-trackings',
